...
train_set_x = images3[0:100]
train_set_y = target3[0:100]    

test_set_x = images3[100:200]
test_set_y = target3[100:200]
...
win1= ring(minds,train_set_x,train_set_y,gen=10,rand=1/10)
win2= ring(minds,train_set_x,train_set_y,gen=100,rand=1/10)
accuracy(win1,test_set_x,test_set_y)

best_random(100,train_set_x, train_set_y)
mind1 = mind()
mind2 = mind()
mind1.J = array([1,-1,1])
mind2.J = array([1,1,1])

genetic_cor(mind1,mind2)
